...
<title>إعلانات و فيديوهات</title>
...
<link href="data:image/x-icon;base64," rel="icon" type="image/x-icon" />
	...
	<!-- videos connect -->
		...
		<meta http-equiv="content-type" content="text/html;charset=utf-8" />
		<meta name="keywords" content="VideoLightBox, LightBox, Video Gallery, Embed Video in Website, Embed Video to Website" />
...
include ("connec.php");
 ...
 $sele = mysql_query("select * from videos where id2!='1' order by id2");
    	...
    	<a class="voverlay" href="index_videolb/vdbplayer.swf?volume=100&url='); echo $row['descr']; echo('" title="'); echo $row['name']; echo('"><div id="imgee2"><div id="imgee3"><img src="'); echo $row['descr2']; echo('" width="200" height="120" alt="'); echo $row['name']; echo('" /></div><div id="txt">'); echo $row['name']; echo('  </div><div id="pl1"></div></div><span></span></a>
		   ...
		   echo('
    <!--	<a class="voverlay" href="index_videolb/vdbplayer.swf?volume=100&url=video/‫â€«ظ…ظ‚ظ„ط¨ ط®ط·ظٹط±â€¬ .3GP" title="Conectar SQL Server con PHP - PHP+MSSQL - WAMP Server - YouTube"><div id="imgee2"><div id="imgee3"><img src="images2/rXPlQ0mHkKI.jpg" width="200" height="120" alt="Conectar SQL Server con PHP - PHP+MSSQL - WAMP Server - YouTube" /></div><div id="txt"> hello makram yes we can do it and you it yes we can  </div><div id="pl1"></div></div><span></span></a>
        
           <br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
   	<a class="voverlay" href="index_videolb/vdbplayer.swf?volume=100&url=video/tagrebah_-_waad_albahri_تجربه_-_وعد_البحرى_-_youtube.FLV" title="Conectar SQL Server con PHP - PHP+MSSQL - WAMP Server - YouTube"><div id="imgee2"><div id="imgee3"><img src="images2/rXPlQ0mHkKI.jpg" width="200" height="120" alt="Conectar SQL Server con PHP - PHP+MSSQL - WAMP Server - YouTube" /></div><div id="txt"> hello makram yes we can do it and you it yes we can  </div><div id="pl1"></div></div><span></span></a>
...
<br><br> ');
 ...
 $selec = mysql_query("select * from videos where id2='1'  ");
			  
			while($rows = mysql_fetch_array($selec)){
			
			echo('
			
  	<a class="voverlay" href="index_videolb/vdbplayer.swf?volume=100&url='); echo $rows['descr']; echo('" title="'); echo $rows['name']; echo('"><div id="imgee22"><div id="imgee33"><img src="'); echo $rows['descr2']; echo('" width="430" height="242" alt="" /></div><div id="txtt">  '); echo $rows['name']; echo('  </div><div id="pl2"></div></div><span></span></a>
