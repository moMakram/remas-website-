...
<div id="body">
<a href="company_map.php"><div id="map"></div></a>
<a href="certificates.php"><div id="certificate"></div></a>
<div id="contact1"></div>
<div id="contact1_column"></div>
<div id="about_usform"></div>
<div id="contact_usform">
<form method="POST"   >
<input name="fullname"  type="text" dir="rtl" style="width:250px; height:30px; color:#333; border:1px #000 groove; position:absolute; font-size:13px; margin-left:40px; border-color:#000 1px;  margin-top:100px; border-radius:3px;" />
<input name="email" type="text"dir="rtl" style="width:250px; height:30px; color:#333; position:absolute;border:1px #000 groove; font-size:13px; margin-left:40px; border-color:#000 1px;  margin-top:170px; border-radius:3px;" />
<input name="address" type="text"dir="rtl" style="width:250px; height:30px; color:#333; position:absolute;border:1px #000 groove; font-size:13px; margin-left:40px; border-color:#000 1px;  margin-top:237px; border-radius:3px;" />
<textarea name="inquiries" cols=""dir="rtl" rows="" wrap="virtual" style="width:250px; max-height:185px;border:1px #000 groove; max-width:250px; height:170px; color:#333; position:absolute; font-size:13px; margin-left:40px;  margin-top:313px; border-radius:3px;  border-color:#666 2px;"></textarea>
<input name="submit"  type="submit" id="submit_button"  style="border:none; "  value=""/>
</form>
...
$inquir = strip_tags( $_POST['inquiries']);
...
$email = strip_tags($_POST['email']);
 ...
 $time =date('H :m');
	...
	$up = mysql_query("insert into contact (name,addr,email,query,date,time) values  ('$name','$addr','$email','$inquir','$date','$time')  ") or die( mysql_error());
...
$(document).ready(function(e) {
  	...
  	if($up){
			alert('تم ارسال الرسالة بنجاح ... انتظروا الرد قريبا جدا ان شاء الله');
...
<div style="position:absolute; margin-left:0px; margin-top:56px; overflow:auto; width:450px; height:290px;">
<table width="400" height="100" border="0" style="overflow:scroll; margin-left:24px; margin-top:px; text-align: center;">
  <tr>
    <td width="199" height="34" background="Images/tr_color2.png"><font color="#FFFFFF" face="adobe Arabic" size="+1">الإجابـات</font></td>
    <td width="191" background="Images/tr_color2.png"><font color="#FFFFFF" face="adobe Arabic" size="+1">الإستفسـارات</font></td>
  </tr>
  
  
<?php
	
					$result = mysql_query(" select * from contact where permis=1 ");

                    while($rows = mysql_fetch_array($result)){
					?>
					 
  <tr>
    <td background="Images/tr_color3.png"  height="33" align="center"><font color="#FFFFFF" size="-5" face="Comic Sans MS, cursive"><?php echo $rows['ans']; ?> </font></td>
    <td background="Images/tr_color4.png"  height="33" align="center"><font color="#FFFFFF" size="-5" face="Comic Sans MS, cursive"><?php echo $rows['query']; ?></font></td>
  </tr>
  <?php } ?>
  <!--
  <tr>
    <td background="Images/tr_color3.png"  height="33" align="center"><font color="#FFFFFF" size="-5" face="Comic Sans MS, cursive"></font></td>
    <td background="Images/tr_color4.png"  height="33" align="center"><font color="#FFFFFF" size="-5" face="Comic Sans MS, cursive"></font></td>
  </tr>
  <tr>
    <td background="Images/tr_color3.png"  height="33" align="center"><font color="#FFFFFF" size="-5" face="Comic Sans MS, cursive"></font></td>
    <td background="Images/tr_color4.png"  height="33" align="center"><font color="#FFFFFF" size="-5" face="Comic Sans MS, cursive"></font></td>
