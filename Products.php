<?php
include ("connec.php");
$select = mysql_query("select * from proditem order by id2 ");
...
<div id="product1"></div>
<div style="position:absolute; margin-left:45px; margin-top:30px; width:944px; height:550px; overflow:auto; ">
<!------------------start--------------------->
');
...
<div id="diary_cont">
<div id="name"><font color="#FFFFFF" > <center> '); echo $rows['prodname'];  echo('  </center><font></div>
...
<td style="border-radius:4px;">
    <a href="information.php?id='); echo $row['id']; echo('"><div style="position:absolute; margin-top:-58px; margin-left:2px; border:1px groove #00F; border-radius:4px; width:132px; height:80px;"><center><img src="'.$row['pic'].'" width="126px"  style=" margin-top:2px;  margin-left:0px; " height="74px"/></center></div></a>
...
<a href="more_milk.php?name='); echo $rows[1]; echo('">
