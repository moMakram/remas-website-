...
$name = strip_tags($_POST['fullnamee']);
$phone = strip_tags( $_POST['phonee']);
$gender = strip_tags($_POST['genderr']);
$addr = strip_tags( $_POST['addresss']);
$email = strip_tags($_POST['emaill']);
	...
	$up = mysql_query("insert into register (name,addr,email,phone,gender) values  ('$name','$addr','$email','$phone','$gender')  ") or die( mysql_error());
...
<script src="jquery-1.9.1.min.js" type="text/jquery"> </script> ');


 echo"<script>
$(document).ready(function(e) {
	$('#submite').click(function(){
		var user = $('#fullnamee').val();
		...
		if(user==''){
			alert('من فضلك ادخل الاسم بالكامل');
		...
		alert('من فضلك ادخل البريد الالكترونى');
		return;
...
<div id="reservate"></div>
<div id="advertise1_column"></div>
<div id="reservate_form">
<div id="fullname"></div>
<form  method="POST" >
<input name="fullnamee"  id="fullnamee" type="text" style=" border-radius:3px; border:groove #000 1px; width:400px; height:26px; margin-left:62px; direction:rtl; margin-top:70px; position:absolute;"  />
<div id="gender"></div>
<select name="genderr" id="genderr"   style=" border-radius:3px; border:groove #000 1px; width:120px; height:26px; margin-left:345px; direction:rtl; margin-top:382px; position:absolute;">
<option>ذكـر</option>
<option>أنثـى</option>
</select>
<div id="address"></div>
<input name="addresss" id="addresss"  type="text" style=" border-radius:3px; border:groove #000 1px; width:400px; height:26px; margin-left:62px; direction:rtl; margin-top:150px; position:absolute;" />
<div id="email"></div>
<input name="emaill" id="emaill"  type="text" style=" border-radius:3px; border:groove #000 1px; width:400px; height:26px; margin-left:62px; direction:ltr; margin-top:305px; position:absolute;" />
<div id="phone"></div>
<input name="phonee" id="phonee"  type="text" style=" border-radius:3px; border:groove #000 1px; width:400px; height:26px; margin-left:62px; direction:rtl; margin-top:230px; position:absolute;" />
<input name="submite" id="submite" type="submit" style="position:absolute; width:82px; height:34px; border:none; background-image:url(Images/button_rservation.png); margin-left:180px; margin-top:430px;"   value="تسجيل" />
<input name="cancel" type="reset"  style="position:absolute; width:82px; height:34px; border:none; background-image:url(Images/button_rservation.png); margin-left:65px; margin-top:430px;" value="إلغاء" />
</form>
