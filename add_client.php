...
<font size="7px"><center>  اضافة الوكلاء </center> </font>
...
if($job!=''){
  ...
  $result=mysql_query("insert into emplye (name,job,descr,id2,place) values ('$name','$job','$descr','$id2','client')");
