...
<title>شركة ريماس للمنتجات الغذائية</title>
...
<link href="css3/styless.css" rel="stylesheet" type="text/css" />
<link href="css3/online-samplee.css" rel="stylesheet" type="text/css" />
<link href="css3/jquery-ui-1.7.3.custome.css" rel="stylesheet" type="text/css" />
...
<div class="coverFlow">
	...
	<?php
	include ("connec.php");
	 $sel = mysql_query("select * from pictures where descr='الصفحة الرئيسية'");
			  
			while($row = mysql_fetch_array($sel)){
			
			echo('
    <li class="childElem  " url="Products.php" mode="_blank"  > <img src="'.$row['place'].'  " width="380" height="250"  >  </li> '); } ?>
...
<div id="object1"><a href="workers.php"><div id="workers"></div></a></div>
<div id="object2"><a href="Contact Us.php"><div id="suggestion"></div></a></div>
<div id="object3"><a href="Products.php"><div id="products"></div></a></div>
<div id="object33"><a href="client.php"><div id="client2"></div></a></div>

<div id="object4"><a href="fields.php"><div id="fields"></div></a></div>
</div>
