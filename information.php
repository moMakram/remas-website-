...
<title>معلومات عن المنتج</title>
<link href="Css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="Css/animate.css" rel="stylesheet" type="text/css" />
<link href="data:image/x-icon;base64," rel="icon" type="image/x-icon" />		<link rel="stylesheet" href="gallery2_files/vlb_files1/vlightbox1.css" type="text/css" />
...
<ul>
   <li><a href="Index.html"><span><font face="Boutros Ads" size="-1">الرئيسية</font></span></a></li>
   <li><a href="About Us.html"><span><font face="Boutros Ads">من نحن</font></span></a></li>
   <li class="last"><a href="Contact Us.html"><span><font face="Boutros Ads">تواصل معنا</font></span></a></li>
   <li><a href="Products.html"><span><font face="Boutros Ads">منتجاتنا</font></span></a></li>
   <li><a href="Advertisment.html"><span><font face="Boutros Ads">فيديوهات</font></span></a></li>
   <li><a href="Reservation.html"><span><font face="Boutros Ads">التسجيل</font></span></a></li>
   <li><a href="company_map.html"><font face="Boutros Ads">مقر الشركة</font></a></li>
...
<div style=" width:900px; height:500px; position:relative; margin-top:57px; margin-left:10px;">

');

$select = mysql_query("select * from proditem where id='$id' ");
$row = mysql_fetch_array($select);

echo('

<div id="info_name">
<div id="info_name2"><center>'); echo $row['name']; echo('</center></div>
</div>
<div id="info_price">
<div id="info_price2"><center>'); echo $row['price']; echo('</center></div>
</div>
<div id="info_qualities">  </div>
<div id="qualities"><div id="qualities2"><center>'); echo $row['descr']; echo('</center></div></div>
<div id="info_image"><div id="info_image2"><img src="'.$row['pic'].'" width="210px" margin-left:20px; margin-top:128px; height="180px"></div></div>
');
