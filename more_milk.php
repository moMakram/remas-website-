...
$select = mysql_query("select * from proditem where place='$name'");
...
<title>المزيد من المنتجات</title>
...
<div id="more_milk">
<div id="name2"><font color="#FFFFFF" > <center><font color="000000">'); echo $name; echo(' </font> </center><font></div>

<div id="more_milk_cont">

<table width="770" height="129" border="0" style="position:absolute; margin-left:63px; margin-top:38px;">
 ...
 <tr>
 <td>
    <a href ="information.php?id='); echo $row['id']; echo('"><img src="'.$row['pic'].'" width="100px" height="100px" style=" margin-top:36px; border-radius:7px; border:inset; "  /></a>
	</td>
	</tr>
	<tr>
	<td align="center">
