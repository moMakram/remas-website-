...
$sel = mysql_query("select * from emplye where place='empl' order by id2");
...
<div id="mang">
<div id="admin2"><center><br /><font size="4px" face="Arial, Helvetica, sans-serif"> '); echo $row['name']; echo('</font></center><center>'); echo $row['job'];echo('  </center></div>
<div id="admline"></div>
<div id="admin3"><center><br />'); echo $row['descr']; echo('</center></div>
</div>
<!-- end -->
<!-- start -->
